...
import { ConfirmationModalProps } from '../../Types/Props/Modal';

const ConfirmationModal = (ConfirmationModalProps: ConfirmationModalProps) => {
    const { onClose, onConfirm } = ConfirmationModalProps;
    return (
