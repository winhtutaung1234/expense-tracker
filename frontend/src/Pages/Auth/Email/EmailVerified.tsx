...
const EmailVerified = () => {
    ...
    return (
        <main className='min-h-[100svh] flex justify-center items-center px-3 dark:bg-dark-custom bg-white-custom'>
            <div className='flex flex-col gap-8 -translate-y-10 md:w-1/2 sm:w-[80%]'>
                ...
                <div className='relative flex justify-end items-center gap-5 sm:p-8 p-3 rounded-md '>
                    ...
                    <div className=' dark:text-white text-[10px] xl:text-[14px] font-montserrat sm:flex-[0.75] flex-[0.7] opacity-0 animate-opacityAppearHalf'>
                    ...
                    <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 dark:bg-gray bg-white rounded-lg -z-10 h-full transition-all border-none animate-takeFullWidth shadow-md'></div>
                </div>
            </div>
        </main>
    );
