        ...
        <main className="dark:bg-dark-custom bg-white-custom min-h-svh flex justify-center items-center">
            <form className="flex items-center flex-col min-w-[330px]">
                ...
                <div className="w-full relative mt-5">
                    ...
                    <input className="dark:bg-gray shadow placeholder:dark:text-white placeholder:opacity-50 placeholder:font-montserrat py-2 ps-10 w-full rounded-md" placeholder="Email or Phone" />
                </div>
