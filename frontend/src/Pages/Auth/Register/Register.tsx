        ...
        <main className="dark:bg-dark-custom bg-white-custom min-h-svh flex justify-center items-center">
            <form className="flex items-center flex-col min-w-[330px]">
                ...
                <div className="w-full relative mt-5">
                    ...
                    <input className="dark:bg-gray placeholder:text-black shadow placeholder:dark:text-white placeholder:opacity-50 placeholder:font-montserrat py-2 ps-10 w-full rounded-md" placeholder="Email or Phone" />
                </div>
                <div className="w-full relative mt-3">
                    ...
                    <input className="dark:bg-gray placeholder:text-black shadow placeholder:dark:text-white placeholder:opacity-50 placeholder:font-montserrat py-2 ps-10 w-full rounded-md" placeholder="Password" />
                </div>
                <div className="w-full relative mt-3">
                    <svg viewBox="0 0 448 512" className='fill-current dark:text-white opacity-50 w-[15px] absolute top-1/2 -translate-y-1/2 translate-x-3'>
                        <path d="M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" />
                    </svg>
                    <input className="dark:bg-gray placeholder:text-black shadow placeholder:dark:text-white placeholder:opacity-50 placeholder:font-montserrat py-2 ps-10 w-full rounded-md" placeholder="Confirm Password" />
                </div>
